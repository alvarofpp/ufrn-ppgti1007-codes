...
public class MyDSLSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        Pessoas pessoas = (Pessoas)theEObject;
        T result = casePessoas(pessoas);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Pessoas</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Pessoas</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T casePessoas(Pessoas object)
  {
    return null;
  }
